          ...
          <div className="space-y-4">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 p-6 shadow-xl backdrop-blur-xl">
              ...
              <div className="relative">
                ...
                <a
                  href="/post"
                  className="mt-5 flex w-full items-center justify-center rounded-2xl bg-blue-600 py-2.5 text-sm font-bold text-white shadow-md shadow-[#27D6D8]/20 hover:bg-blue-700"
                >
                  + Send Appreciation
                </a>
              </div>
