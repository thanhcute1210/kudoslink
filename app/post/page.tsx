        ...
        <div className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 p-8 text-center shadow-2xl backdrop-blur-xl">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <button
              ...
              className="rounded-full bg-blue-600 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-blue-200 hover:bg-blue-700"
            >
              View Feed
            </button>
            <button
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
            ...
            <div className="relative space-y-5">
                ...
                >
                  ...
                  {otherProfiles.map((p) => (
                    <option key={p.id} value={p.full_name}>
                      {p.full_name} ({p.office} · {p.department})
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Great support on M&A research"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe what they did, why it was valuable, and how it helped the team..."
                  rows={5}
                    ...
                    <button
                      ...
                      className={"rounded-full px-4 py-2 text-sm font-bold ring-1 transition " + (
                        selectedPoints === p
                          ...
                          : p > remaining
                          ? "opacity-40 cursor-not-allowed bg-white text-slate-400 ring-slate-200"
          ...
          <aside className="space-y-4">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 p-5 shadow-xl backdrop-blur-xl">
              <h2 className="text-base font-bold text-slate-950">Good appreciation formula</h2>
              <div className="mt-4 space-y-3">
                {[["1", "What they did"], ["2", "Why it helped"], ["3", "Business impact"]].map(([num, text]) => (
                  <div key={num} className="flex items-center gap-3 rounded-2xl bg-slate-50 px-4 py-3 ring-1 ring-slate-200">
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-600 text-xs font-bold text-white">{num}</span>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 p-5 shadow-xl backdrop-blur-xl">
              ...
              <div className="mt-4 space-y-3 text-sm">
                <div className="flex justify-between rounded-2xl bg-blue-50 px-4 py-3 text-blue-700 ring-1 ring-blue-100">
                  <span className="font-semibold">Small help</span>
                  <span className="font-bold">10–20 pts</span>
                </div>
                <div className="flex justify-between rounded-2xl bg-emerald-50 px-4 py-3 text-emerald-700 ring-1 ring-emerald-100">
                  <span className="font-semibold">Strong support</span>
                  <span className="font-bold">30–50 pts</span>
                </div>
                <div className="flex justify-between rounded-2xl bg-amber-50 px-4 py-3 text-amber-700 ring-1 ring-amber-100">
                  <span className="font-semibold">Above & beyond</span>
